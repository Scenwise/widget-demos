export const heatmapLayer = (id: string, source: string, opacity_level_start: number, weight: number) => ({
    id: id,
    type: 'heatmap',
    source: source,
    paint: {
        ...
        'heatmap-radius': ['interpolate', ['linear'], ['zoom'], 0, 0.1, 7, 12],
        'heatmap-opacity': ['interpolate', ['linear'], ['zoom'], opacity_level_start, 0.9, 12, 0.1],
    },
});
